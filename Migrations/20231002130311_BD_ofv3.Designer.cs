...
namespace webapi.healthclinic.manha.Migrations
{
    ...
    [Migration("20231002130311_BD_ofv3")]
    partial class BD_ofv3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapi.healthclinic.manha.Domains.Consulta", b =>
                {
                    ...
                    b.Property<DateTime?>("DataAgentamento")
                        .IsRequired()
                        .HasColumnType("DATETIME");

                    b.Property<Guid>("IdDescricao")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("webapi.healthclinic.manha.Domains.Descricao", b =>
                {
                    b.Property<Guid>("IdDescricao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("IdDescricao");

                    b.ToTable("Descricao");
                });

            modelBuilder.Entity("webapi.healthclinic.manha.Domains.EspecialidadeMedico", b =>
                {
            ...
            modelBuilder.Entity("webapi.healthclinic.manha.Domains.Consulta", b =>
                {
                    b.HasOne("webapi.healthclinic.manha.Domains.Descricao", "Descricao")
                        .WithMany()
            ...
            modelBuilder.Entity("webapi.healthclinic.manha.Domains.Medico", b =>
                {
                    ...
                    b.HasOne("webapi.healthclinic.manha.Domains.EspecialidadeMedico", "EspecialidadeMedico")
                        .WithMany()
